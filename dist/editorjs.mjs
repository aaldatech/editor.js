...
var Kt = (r, e, t) => e in r ? Yt(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var ne = (r, e, t) => (Kt(r, typeof e != "symbol" ? e + "" : e, t), t);
...
let Xt = (r = 21) => crypto.getRandomValues(new Uint8Array(r)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
class D extends Ie {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      c || u ? h = !0 : h = !(l.length > 0 && l.every((b) => {
        const { addedNodes: f, removedNodes: k, target: A } = b;
        return [
          ...Array.from(f),
          ...Array.from(k),
          A
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([n, s]) => t[n] && ro(t[n], s)));
  }
  /**
  ...
  async exportDataAsString() {
    ...
    return po(e, this.tool.conversionConfig);
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((n) => uo(n, this.toolRenderedElement)) && this.didMutated(o);
          ...
          return this.map(function(s) {
            var a = function(l, c) {
              ...
              if (c && typeof btoa == "function") {
                var p = (f = h, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(f)))) + " */"), b = h.sources.map(function(k) {
...
`);
      ...
      function A(v, g) {
        ...
        var B = p[p.length - 1];
        if (v.insertAt === "top")
          B ? B.nextSibling ? w.insertBefore(g, B.nextSibling) : w.appendChild(g) : w.insertBefore(g, w.firstChild), p.push(g);
      ...
      function U(v, g) {
        ...
        if (g.singleton) {
          ...
          v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (w = function(C) {
            ...
            var ee = ue.css, Le = ue.sourceMap, $t = $.convertToAbsoluteUrls === void 0 && Le;
            ($.convertToAbsoluteUrls || $t) && (ee = b(ee)), Le && (ee += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Le)))) + " */");
            var Wt = new Blob([ee], { type: "text/css" }), Ze = C.href;
            C.href = URL.createObjectURL(Wt), Ze && URL.revokeObjectURL(Ze);
      ...
      t.exports = function(v, g) {
        ...
        var w = k(v, g);
        return f(w, g), function(B) {
          for (var M = [], T = 0; T < w.length; T++) {
            var N = w[T];
            (C = a[N.id]).refs--, M.push(C);
          }
          for (B && f(k(B, g), g), T = 0; T < M.length; T++) {
            var C;
            if ((C = M[T]).refs === 0) {
...
`);
      ...
      t.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l, c) {
          var u, h = c.trim().replace(/^"(.*)"$/, function(p, b) {
            return b;
      ...
      var n, s, a, l, c, u, h, p, b;
      t.exports = (n = "cdx-notifies", s = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", c = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", p = "cdx-notify__btns-wrapper", { alert: b = function(f) {
        var k = document.createElement("DIV"), A = document.createElement("DIV"), _ = f.message, I = f.style;
        ...
        var k = b(f), A = document.createElement("div"), _ = document.createElement("button"), I = document.createElement("button"), J = k.querySelector("." + a), U = f.cancelHandler, j = f.okHandler;
        return A.classList.add(p), _.innerHTML = f.okText || "Confirm", I.innerHTML = f.cancelText || "Cancel", _.classList.add(h), I.classList.add(h), _.classList.add(l), I.classList.add(c), U && typeof U == "function" && (I.addEventListener("click", U), J.addEventListener("click", U)), j && typeof j == "function" && _.addEventListener("click", j), _.addEventListener("click", k.remove.bind(k)), I.addEventListener("click", k.remove.bind(k)), A.appendChild(_), A.appendChild(I), k.appendChild(A), k;
      }, prompt: function(f) {
        var k = b(f), A = document.createElement("div"), _ = document.createElement("button"), I = document.createElement("input"), J = k.querySelector("." + a), U = f.cancelHandler, j = f.okHandler;
        return A.classList.add(p), _.innerHTML = f.okText || "Ok", _.classList.add(h), _.classList.add(l), I.classList.add(u), f.placeholder && I.setAttribute("placeholder", f.placeholder), f.default && (I.value = f.default), f.inputType && (I.type = f.inputType), U && typeof U == "function" && J.addEventListener("click", U), j && typeof j == "function" && _.addEventListener("click", function() {
          j(I.value);
...
(function(r, e) {
  (function(t, o) {
    ...
    function t(h) {
      var p = h.tags, b = Object.keys(p), f = b.map(function(k) {
        return typeof p[k];
      }).every(function(k) {
    ...
    t.prototype.clean = function(h) {
      ...
      return b.innerHTML = h, this._sanitize(p, b), b.innerHTML;
    }, t.prototype._sanitize = function(h, p) {
      var b = a(h, p), f = b.firstChild();
      if (f)
        do {
          ...
          var k = s(f), A;
          k && (A = Array.prototype.some.call(f.childNodes, i));
          var _ = !!p.parentNode, I = i(p) && i(f) && _, J = f.nodeName.toLowerCase(), U = l(this.config, J, f), j = k && A;
          if (j || c(f, U) || !this.config.keepNestedBlockElements && I) {
          ...
          for (var Q = 0; Q < f.attributes.length; Q += 1) {
            var he = f.attributes[Q];
            u(he, U, f) && (f.removeAttribute(he.name), Q = Q - 1);
          }
          this._sanitize(h, f);
    ...
    function l(h, p, b) {
      return typeof h.tags[p] == "function" ? h.tags[p](b) : h.tags[p];
    }
    function c(h, p) {
    ...
    function u(h, p, b) {
      ...
      return p === !0 ? !1 : typeof p[f] == "function" ? !p[f](h.value, b) : typeof p[f] > "u" || p[f] === !1 ? !0 : typeof p[f] == "string" ? p[f] !== h.value : !1;
    }
    return t;
  });
})(vt);
var Co = vt.exports;
const To = /* @__PURE__ */ Te(Co);
function ze(r, e) {
  return r.map((t) => {
...
function X(r, e = {}) {
  ...
  return new To(t).clean(r);
}
function Ue(r, e) {
  return Array.isArray(r) ? So(r, e) : P(r) ? Io(r, e) : q(r) ? Mo(r, e) : r;
}
function So(r, e) {
...
let Qo = Bt;
var ei = Object.defineProperty, ti = Object.getOwnPropertyDescriptor, oi = (r, e, t, o) => {
...
const Ct = class R extends Ie {
  ...
  constructor(e) {
    var s, a;
    super(), this.scopeElement = document.body, this.listeners = new Fe(), this.scrollLocker = new Qo(), this.nodes = {
      wrapper: null,
      popover: null,
      ...
      this.items.find((c) => c.isFocused).onFocus();
    };
    const t = ((a = (s = e.items) == null ? void 0 : s[0]) == null ? void 0 : a.type) === 0, o = [
      "Key Vitals",
      "PE/ROS",
      "Test & Report",
      "Internal Documents",
  ...
  toggleItemActivenessIfNeeded(e) {
    if (typeof e.toggle == "function")
      e.toggleActive(e.toggle());
    else if (e.toggle === !0)
      e.toggleActive();
    else if (typeof e.toggle == "string") {
...
const le = new ri();
var ai = Object.defineProperty, li = Object.getOwnPropertyDescriptor, It = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? li(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
class hi extends E {
  ...
  async make() {
    ...
    const t = d.make("div"), o = d.text(H.ui(K.ui.blockTunes.toggler, "Click to tune")), i = await di("Slash", "/");
   ...
   */
  makeToolbox() {
    return this.toolboxInstance = new ci({
...
class pi extends E {
   ...
   */
  arrowRightAndDown(e) {
    const t = Z.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === x.TAB);
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (Z.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === x.TAB))
        return;
...
const st = "block-removed", rt = "block-added", fi = "block-moved", at = "block-changed";
class gi {
  constructor() {
...
class mi extends E {
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(fi, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
...
const _t = (r, e) => {
  if (typeof r == "object" && r !== null) {
    if (r.hasOwnProperty("row_ulid")) {
      const t = r.row_ulid;
      r.row_ulid = ce.generate().toString(), Nt(e, t, r.row_ulid), r != null && r.parent_id || (r.isMainMed = !0);
    }
    r.hasOwnProperty("ulid") && r.ulid && r.ulid.length > 5 && (r.ulid = ce.generate().toString());
    for (const t in r)
      r.hasOwnProperty(t) && _t(r[t], e);
  }
}, Nt = (r, e, t) => {
  if (typeof r == "object" && r !== null) {
    r.hasOwnProperty("parent_id") && r.parent_id === e && (r.parent_id = t);
    for (const o in r)
      r.hasOwnProperty(o) && Nt(r[o], e, t);
  }
  return r;
}, y = class y {
  constructor(e, t, o = !1) {
...
const Rt = class Dt extends E {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    if (s)
      try {
        ...
        _t(p, p), this.insertEditorJSData(p);
        return;
      } catch {
      }
    t && a.trim() && l.trim() && (l = "<p>" + (l.trim() ? l : a) + "</p>");
    const c = Object.keys(this.toolsTags).reduce((p, b) => (p[b.toLowerCase()] = this.toolsTags[b].sanitizationConfig ?? {}, p), {}), u = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }), h = X(l, u);
   ...
   */
  async processFile(e) {
    const t = Qt(e), o = Object.entries(this.toolsFiles).find(([s, { mimeTypes: a, extensions: l }]) => {
      const [c, u] = e.type.split("/"), h = l.find((b) => b.toLowerCase() === t.toLowerCase()), p = a.find((b) => {
        const [f, k] = b.split("/");
        return f === c && (k === u || k === "*");
      });
      return !!h || !!p;
  ...
  processHTML(e) {
    ...
    return o.innerHTML = e, this.getNodes(o).map((n) => {
      ...
      const { tags: c } = a.pasteConfig || { tags: [] }, u = c.reduce((b, f) => (this.collectTagNames(f).forEach((A) => {
        const _ = P(f) ? f[A] : null;
        b[A.toLowerCase()] = _ || {};
  ...
  async processInlinePaste(e) {
    ...
    if (t.currentBlock && t.currentBlock.tool.isDefault && i.textContent.length < Dt.PATTERN_PROCESSING_MAX_LENGTH) {
...
Rt.PATTERN_PROCESSING_MAX_LENGTH = 450;
let wi = Rt;
class yi extends E {
  constructor() {
...
class be extends E {
  ...
  trySelectNextBlock(e) {
    ...
    let l = s;
    o > 1 && (l = a ? i : n);
    const c = e > this.stackOfSelected[o - 1] && l === i, u = e < this.stackOfSelected[o - 1] && l === n, p = !(c || u || l === s);
...
const Ci = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
function Ti(r) {
...
class Ge {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = $o, this.nodes.button;
  }
  /**
...
class Xe {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = Go, this.nodes.button;
  }
  /**
...
var Mi = Object.defineProperty, Li = Object.getOwnPropertyDescriptor, Ft = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Li(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
Ut.isTune = !0;
var Oi = Object.defineProperty, _i = Object.getOwnPropertyDescriptor, Ni = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? _i(e, t) : e, n = r.length - 1, s; n >= 0; n--)
    (s = r[n]) && (i = (o ? s(e, t, i) : s(i)) || i);
...
class jt extends E {
  ...
  async prepare() {
    ...
    this.factory = new Ai(e, this.config, this.Editor.API);
...
class Pi extends E {
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(t) && o) {
      ...
      const i = t.getAttribute("href"), n = oo(i);
      no(n);
      return;
    }
...
const Fi = {
  ...
  BlockSelection: bi,
  Caret: Ce,
  CrossBlockSelection: ki,
  DragNDrop: vi,
  ModificationsObserver: xi,
  Paste: wi,
  ReadOnly: yi,
...
class Hi {
  ...
  set configuration(e) {
    ...
    P(e) ? this.config = {
      ...
      holder: e
    }, Re(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = lt.VERBOSE), qt(this.config.logLevel), Re(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
