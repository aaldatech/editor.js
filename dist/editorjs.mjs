...
class E {
  ...
  get isNEWMEDICINEOFF() {
    var e;
    return ((e = this.config) == null ? void 0 : e.NEW_MEDICINE_OFF) ?? !1;
  }
  /**
...
const Nt = class Rt extends E {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    if (s)
      try {
        let p = JSON.parse(s);
        console.log(p), p = p.filter((b) => b.tool != (o.isNEWMEDICINEOFF ? "medicine_v2" : "Medicine")), _t(p), this.insertEditorJSData(p);
        return;
      } catch {
      }
